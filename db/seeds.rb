...
unit3 = Unit.create!(name: 'Ragnar and The Boys' ,category: 'Neighbour disputes', address: 'Hakovshim 14, Tel Aviv',  description: 'Specialized on solving financial disputes', user_id: user.id, photo:'https://pmctvline2.files.wordpress.com/2019/07/scream-resurrection-finale.jpg?w=620&h=420&crop=1')
...
unit5 = Unit.create!(name: 'Pablos Merry Bandits' ,category: 'Financial Problems', address: 'Gordon 14, Tel Aviv',  description: 'Nothing we cannot due for you', user_id: user.id, photo:'https://cdn.websites.hibu.com/b44ffcdb354947e89cd60e0c13371c97/dms3rep/multi/desktop/Private+Detective+Iowa+Investigations+Investigator.JPG')
